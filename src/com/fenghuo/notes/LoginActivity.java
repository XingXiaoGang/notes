...
public class LoginActivity extends Activity implements View.OnClickListener, IUiListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestCode = getIntent().getIntExtra(AccountProfileManager.EXTRA_REQUEST, 0);
    }
    ...
    private synchronized void doLogin() {
        if (mTencent == null) {
            mTencent = Tencent.createInstance(Config.APP_ID, this.getApplicationContext());
        }
    ...
    public void onComplete(Object o) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, "解析登录结果失败 :" + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
