...
//		mToDownAnimation = new RotateAnimation(0, 90, 0.5f, 0.5f);
//		mToDownAnimation.setDuration(500);
//		mToDownAnimation.setFillAfter(true);
//		mToRightAnimation = new RotateAnimation(0, -90, 0.5f, 0.5f);
//		mToRightAnimation.setDuration(500);
